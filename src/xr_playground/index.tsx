...
const store = createXRStore({ foveation: 0, emulate: { syntheticEnvironment: true } })
                    ...
                    <Container width="100%" flexDirection="row" flexGrow={1}>
                      ...
                      >
                        ...
                        <Container flexDirection="row" alignItems="center" justifyContent="space-between">
                          <Text color={colors.cardForeground}>Mesh1</Text>
                            <Button
                              size="icon"
                              variant="ghost"
                              onClick={() => console.log('Download Mesh1')}
                            >
                              <DownloadIcon width={16} color={colors.cardForeground} />
                            </Button>
                        </Container>
                        <Container flexDirection="row" alignItems="center" justifyContent="space-between">
                          <Text color={colors.cardForeground}>Mesh2</Text>
                            <Button
                              size="icon"
                              variant="ghost"
                              onClick={() => console.log('Download Mesh2')}
                            >
                              <DownloadIcon width={16} color={colors.cardForeground} />
                            </Button>
                        </Container>
                        ...
                        <Container flexDirection="row" alignItems="center" justifyContent="space-between">
                          <Text color={colors.cardForeground}>Mesh3</Text>
                            <Button
                              size="icon"
                              variant="ghost"
                              onClick={() => console.log('Download Mesh3')}
                            >
                              <DownloadIcon width={16} color={colors.cardForeground} />
                            </Button>
                        </Container>
                        ...
                        <Container flexShrink={0} display="flex" flexDirection="column" gapRow={16} padding={32}>
                          <Container display="flex" alignItems="center" flexDirection="row" gapColumn={16}>
                            {/* <Image
                              ...
                              flexDirection="column"
                            ></Image> */}
                            <Container flexGrow={1} flexShrink={1} flexBasis="0%" flexDirection="row" gapRow={4}>
                              <Button
                                    size="icon"
                                    variant="ghost"
                                    hover={{ backgroundColor: 'deepgrey', scale: 1.1 }}
                                    onClick={() => console.log('Upload Local File')}
                                  >
                                    <ImageUpIcon width={32} color={colors.cardForeground} />
                              </Button>
                              <Text
                                fontSize={14}
                                fontWeight={500}
